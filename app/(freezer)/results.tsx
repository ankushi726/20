...
- Temperature: ${results.conditions?.externalTemp || 35}°C → ${results.conditions?.internalTemp || -18}°C
...
Generated by Enzo CoolCalc
  ...
  const handleSaveToFile = () => {
    Alert.alert(
      'Save Options',
      'Choose how to save your report:',
      [
        { text: 'Share via WhatsApp', onPress: () => shareViaApp('whatsapp') },
        { text: 'Share via Telegram', onPress: () => shareViaApp('telegram') },
        { text: 'Save as Text', onPress: handleShare },
  ...
  const shareViaApp = async (app: string) => {
    ...
    try {
      ...
      Alert.alert('Error', `Failed to share via ${app}`);
    }
  };
  ...
  return (
    <LinearGradient colors={['#F8FAFC', '#EBF8FF']} style={styles.container}>
      ...
      <View style={styles.shareButtonsContainer}>
        ...
        <TouchableOpacity style={styles.shareButton} onPress={handleSaveToFile}>
          <Download color="#3B82F6" size={20} strokeWidth={2} />
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoText}>• Total Air Flow: {(results.conditions?.totalAirFlow || 0).toFixed(0)} CFM</Text>
            <Text style={styles.infoText}>• Air Flow per Fan: {(results.conditions?.airFlowPerFan || 0).toFixed(0)} CFM</Text>
          ...
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoText}>• Maximum Capacity: {(results.storageCapacity?.maximum || 0).toFixed(0)} kg</Text>
            <Text style={styles.infoText}>• Current Utilization: {(results.storageCapacity?.utilization || 0).toFixed(1)}%</Text>
